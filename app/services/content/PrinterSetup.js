    ...
    <div className="flex flex-col items-center py-14 space-y-14 mt-[-33px] bg-[#007DBD] mt-[7px]">
      ...
      <div className="flex flex-col md:flex-row items-center md:items-start space-y-10 md:space-y-0 md:space-x-12 w-full max-w-7xl p-10 border border-gray-200 rounded-lg shadow-lg">
        ...
        <div className="w-full md:w-1/2 space-y-8">
          <h2 className="text-4xl font-bold text-white">How to Set Up Your Printer</h2> {/* Further increased text size */}
          <p className="text-xl leading-relaxed text-white">
            Click Printer Setup for step-by-step guidance on how to set up, configure, and register your printer.
          </p>
          <button 
            className="bg-white text-white py-3 px-8 rounded text-lg font-medium hover:bg-blue-200 transition duration-200"
            onClick={handleSetupClick}
          >
            <p className='text-[#007DBD]'>
              Printer Setup
            </p>
          </button>
          <div className="text-lg">
            <span className="font-semibold text-white">More support</span><br />
